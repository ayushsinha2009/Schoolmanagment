...
using System.Data;
using System.IO;
public partial class TTeacher_PA : System.Web.UI.Page
{
    ...
    {
        dt = obj.CheckStudentAttendancePresent();
        gvdetails.DataSource = dt;
        gvdetails.DataBind();

        dt1 = obj.CheckStudentAttendanceAbsent();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        Response.ContentType = "application/StudentAttendance.ms-excel";
    ...
    {
        dt4 = obj.CheckPD(txtdate.Text, txttill.Text, Convert.ToInt32(ddnclass.SelectedValue), Convert.ToInt32(ddnsection.SelectedValue));
        gvdetails.DataSource = dt4;
        gvdetails.DataBind();


        dt5=obj.CheckAD(txtdate.Text, txttill.Text, Convert.ToInt32(ddnclass.SelectedValue), Convert.ToInt32(ddnsection.SelectedValue));
        gvdetails1.DataSource = dt5;
        gvdetails1.DataBind();
    }
}