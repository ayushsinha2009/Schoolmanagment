...
public partial class TTeacher_Activity : System.Web.UI.Page
{
    ...
    {
        i = obj.AddStudentextraactivity(Convert.ToInt32(ddnstudent.SelectedValue), Convert.ToInt32(ddnclass.SelectedValue), Convert.ToInt32(ddnsection.SelectedValue),
            txtactivity.Text, txtdesc.Text, "Teacher", Convert.ToInt32(Session["tuid"]), DateTime.Now.ToString());
        if (i > 0)
        {
            lblmsg.Text = "Data Has Been Inserted";

            s = "Welcome Mr." + str + " Your Ward Partcipited in Extra Co Curricular Activity::" + txtactivity.Text;
            s1 = "Welcome Mr." + str1 + " Your Ward Partcipited in Extra Co Curricular Activity::" + txtactivity.Text;
            SendSMS(str, s);
            SendSMS(str1, s1);
            BindData();
            ClearFields();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        Response.ContentType = "application/Activity.ms-excel";
    ...
    {
        dt = obj.SelectStudentExtraActivity(Convert.ToInt32(Session["tuid"]));
