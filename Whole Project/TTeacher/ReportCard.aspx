<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportCard.aspx.cs" Inherits="TTeacher_ReportCard" %>
    ...
    <div>
       <table style="width: 100%;">
           ...
           <tr>
                ...
                <td>Reading::<asp:Label ID="lblreading" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td></td>
           ...
           <tr>
                <td>Writing:<asp:Label ID="lblwriting" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td></td>
            ...
            <tr>
                <td>English::<asp:Label ID="lblenglish" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td></td>
            ...
            <tr>
                <td>Hindi::<asp:Label ID="lblhindi" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td></td>
              ...
              <tr>
                <td>Maths::<asp:Label ID="lblmaths" runat="server"></asp:Label>
                    <br />
                    <br />
                  </td>
                <td></td>
              ...
              <tr>
                <td>Science::<asp:Label ID="lblscience" runat="server"></asp:Label>
                    <br />
                    <br />
                  </td>
                <td>&nbsp;</td>
           ...
           <tr>
                <td>Health::<asp:Label ID="lblhealth" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td>&nbsp;</td>
           ...
           <tr>
                <td>Physical Education::<asp:Label ID="lbledu" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td>&nbsp;</td>
           ...
           <tr>
                <td>Teacher Remarks::<asp:Label ID="lblremarks" runat="server"></asp:Label>
                    <br />
                    <br />
                </td>
                <td>&nbsp;</td>
