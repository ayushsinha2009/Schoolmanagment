<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLogin/MasterPage.master" AutoEventWireup="true" CodeFile="AddCurriculumn.aspx.cs" EnableEventValidation="false" Inherits="AdminLogin_AddCurriculumn" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Curriculum Master</h1>
                <small>Enter details of Curriculum names here..</small>
            </div>
        </section>
                    ...
                    <div class="panel lobidisable panel-bd">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="BtnAdd" CssClass="btn btn-add" runat="server" Text="Add Curriculmn" ValidationGroup="c" OnClick="BtnAdd_Click" />
                               <asp:Button ID="Btnupdate" CssClass="btn btn-add" runat="server" Text="Update Curriculmn" OnClick="Btnupdate_Click"  />
                                <asp:Button ID="Btndel" CssClass="btn btn-add" runat="server" Text="Delete Curriculmn" OnClick="Btndel_Click" />
