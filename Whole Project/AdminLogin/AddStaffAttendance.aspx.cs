...
public partial class AdminLogin_AddStaffAttendance : System.Web.UI.Page
{
    ...
    {
        dt1 = obj.SelectStaffIdWise();
        ddnstaff.DataSource = dt1;
    ...
    protected void BtnAdd_Click(object sender, EventArgs e)
    {
        ...
        dtA = obj.CheckAttendance(txtdate.Text, strmonth, strday, Convert.ToInt32(ddnstaff.SelectedValue));
        if (dtA.Rows.Count > 0)
        {
        ...
        if (dtA.Rows.Count <= 0)
        {
            ...
            i = obj.AddStaffAttendance(Convert.ToInt32(ddnstaff.SelectedValue), txtdate.Text, strmonth, strday, txttimein.Text, txttimeout.Text, txttwhrs.Text, ddnprsnt.SelectedItem.Text, "Admin", 1, DateTime.Now.ToString());
            if (i > 0)
            {
