<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLogin/MasterPage.master" AutoEventWireup="true" CodeFile="AddTeacherAttendance.aspx.cs" EnableEventValidation="false" Inherits="AdminLogin_AddTeacherAttendance" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                ...
                <small>Enter Teacher Attendance..</small>
                <br />
        ...
        <section class="content">
                    ...
                    <div class="panel lobidisable panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4>Teacher Attendance Details</h4>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Is Teacher Present or Not</label><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddnprsnt" InitialValue="0" ErrorMessage="*" ValidationGroup="c"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="BtnAdd" CssClass="btn btn-add" runat="server" Text="Add Teacher Attendance" ValidationGroup="c" OnClick="BtnAdd_Click" />
            ...
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvdetails" Cssclass="table table-hover" runat="server" BackColor="White" BorderColor="#CCCCCC"  EmptyDataText="No Record!" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gvdetails_PageIndexChanging" PageSize="25">
                                    ...
                                    <SelectedRowStyle BackColor="#CC3333" Font-Bold="True" ForeColor="White" />
                                                    <Columns>
                    <asp:BoundField DataField="teacherAttendanceId" HeaderText=" S.No. " />
                    <asp:BoundField DataField="FullName" HeaderText="teacher Full Name" /> 
                    <asp:BoundField DataField="teacherid" HeaderText="teacher Id" Visible="false" /> 
                    ...
                    <asp:BoundField DataField="teacherPresent_Absent" HeaderText="Teacher Present Absent" />
