<%@ Page Title="" Language="C#" MasterPageFile="~/AAcountant/AMasterPage.master" AutoEventWireup="true" CodeFile="StaffSalary.aspx.cs" EnableEventValidation="false" Inherits="AAcountant_StaffSalary" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Staff Salary</h1>
                <small>Staff Salary Details..</small>
            </div>
        </section>
        <section class="content">
                    ...
                    <div class="panel lobidisable panel-bd">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddnstaff" ValidationGroup="c" CssClass="form-control" AutoPostBack="true"  runat="server" OnSelectedIndexChanged="ddnstaff_SelectedIndexChanged"></asp:DropDownList>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <asp:BoundField DataField="StaffFirstName" HeaderText="Name" /> 
